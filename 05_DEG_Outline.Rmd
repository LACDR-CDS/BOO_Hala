...
contrast_sub <- contrast_low %>% 
  filter(mean_ID == i) 
#It keeps only the row(s) where the value in the mean_ID column is equal to the value currently stored in the variable i (which is the first treatment condition, e.g., "CS1106_1_P1").
...
write.csv(countData,"output/low_store.csv")
write.csv(metaData,"output/high_store.csv")
